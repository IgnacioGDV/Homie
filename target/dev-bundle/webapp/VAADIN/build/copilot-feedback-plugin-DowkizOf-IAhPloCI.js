import { c as ct, A as A$1, $ as $$1, d as dn, i as fe, j as Ce, k as $c, a as cl } from "./indexhtml-DiL04ybs.js";
import { g } from "./state-CpHuw1-w-Bp2DjuZw.js";
import { u as u$1, v } from "./overlay-monkeypatch-C6Ef2C3V-So13HYcu.js";
import { o as o$1 } from "./base-panel-BPFs0JUr-DEFdrZ1U.js";
...
let i = class extends o$1 {
  ...
  renderFooter() {
    return this.message === void 0 ? ct`
          <div class="dialog-footer">
            <vaadin-button
              theme="tertiary"
              @click="${() => A$1.emit("system-info-with-callback", {
  ...
  close() {
    $$1.updatePanel("copilot-feedback-panel", {
      floating: false
    });
  }
  submit() {
    var _a;
    if (dn("feedback"), this.description.trim() === "") {
    ...
    A$1.emit("system-info-with-callback", {
      callback: (t) => fe(`${Ce}feedback`, { ...e, versions: t }),
      notify: false
